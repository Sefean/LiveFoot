...
export default function SelectPlayerComment({route, navigation}) {
    
    const params = route.params;

    const [comentario, setComentario] = useState("");
    const [jugadorComentario, setJugadorComentario] = useState(0);

    const addJugadorToComment = (jugador) =>
    {
        setComentario(comentario + jugador.nombre);
        setJugadorComentario(jugador.id_jugador);
    }
